...
__device__ inline __hip_bfloat162 my_unsafeAtomicAdd(__hip_bfloat162* address, __hip_bfloat162 value) {
...
__device__ inline __half2 my_unsafeAtomicAdd(__half2* address, __half2 value) {
#if (defined(__gfx940__) || defined(__gfx941__) || defined(__gfx942__)) && \
...
#define ATOMICADD my_unsafeAtomicAdd
