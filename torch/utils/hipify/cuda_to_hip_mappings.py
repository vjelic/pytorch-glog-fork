...
CUDA_SPARSE_MAP = collections.OrderedDict(
    [
        ...
        ("cusparseCcsrgemm2_bufferSizeExt", ("hipsparseCcsrgemm2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE)),
        ("cusparseZcsrgemm2_bufferSizeExt", ("hipsparseZcsrgemm2_bufferSizeExt", CONV_MATH_FUNC, API_SPARSE)),
        ("cusparseCcsrgemm2", ("hipsparseCcsrgemm2", CONV_MATH_FUNC, API_SPARSE)),
        ("cusparseZcsrgemm2", ("hipsparseZcsrgemm2", CONV_MATH_FUNC, API_SPARSE)),
