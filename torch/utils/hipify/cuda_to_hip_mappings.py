...
CUDA_IDENTIFIER_MAP = collections.OrderedDict(
    [
        ...
        ("cublasComputeType_t", ("hipblasLtComputeType_t", CONV_MATH_FUNC, API_BLAS)),
        ("CUBLAS_COMPUTE_32F", ("HIPBLASLT_COMPUTE_F32", CONV_MATH_FUNC, API_BLAS)),
        ("CUBLAS_COMPUTE_64F", ("HIPBLASLT_COMPUTE_F32", CONV_MATH_FUNC, API_BLAS)),
