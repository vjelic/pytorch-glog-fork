...
module_tests = [
    ...
    dict(
        ...
        with_tf32=True,
        tf32_precision=0.07 if torch.version.hip else 0.005,
    ),
    dict(
...
new_module_tests = [
    ...
    dict(
        ...
        with_tf32=True,
        tf32_precision=0.5 if torch.version.hip else 0.1,
    ...
    dict(
        ...
        desc='relu_activation',
        with_tf32=True,
        tf32_precision=0.25 if torch.version.hip else 0.05,
    ),
    dict(
        module_name='TransformerDecoderLayer',
        constructor_args=(4, 2, 8, 0.0, F.gelu),
        ...
        desc='gelu_activation',
        with_tf32=True,
        tf32_precision=0.3 if torch.version.hip else 0.05,
    ),
    dict(
        ...
        with_tf32=True,
        tf32_precision=0.5 if torch.version.hip else 0.02,
    ),
    dict(
        module_name='Linear',
