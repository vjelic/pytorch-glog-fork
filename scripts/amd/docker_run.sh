...
IMAGE_NAME=compute-artifactory.amd.com:5000/rocm-plus-docker/framework/compute-rocm-dkms-no-npi-hipclang:8518_ubuntu18.04_py3.6_pytorch_rocm4.5_internal_testing_eeaa676_4138
