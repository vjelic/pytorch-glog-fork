...
hip_platform_files = [
    ...
    "third_party/fbgemm/fbgemm_gpu/codegen/embedding_forward_quantized_split_template.cu",
    ...
    "third_party/fbgemm/fbgemm_gpu/src/merge_pooled_embeddings_gpu.cpp",
    "third_party/fbgemm/fbgemm_gpu/src/metric_ops.cu",
...
for hip_platform_file in hip_platform_files:
    ...
    if os.path.exists(hip_platform_file):
        ...
        newlines = [line.replace("HIP_HCC_FLAGS", "HIP_CLANG_FLAGS") for line in newlines]
        if lines == newlines:
