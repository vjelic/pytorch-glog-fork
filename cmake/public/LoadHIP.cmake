...
if(NOT DEFINED ENV{MIOPEN_LIBRARY})
  set(MIOPEN_PATH /opt/rocm/miopen)
else()
  set(MIOPEN_PATH $ENV{MIOPEN_LIBRARY})
endif()
...
elseif(WIN32)
  ...
  if(hip_FOUND)
    ...
    if(FOUND_HIP_VERSION_H)
      ...
      message(STATUS "Caffe2: Header version is: " ${hip_version_from_header})
    ...
    if(HIP_VERSION_DEV_MATCH)
      ...
      math(EXPR HIP_VERSION_DEV_INT "(${HIP_VERSION_DEV_MAJOR}*10000) + (${HIP_VERSION_DEV_MINOR}*100) + ${HIP_VERSION_DEV_PATCH}")
    endif()
    ...
    message("HIP_VERSION_DEV_INT:   ${HIP_VERSION_DEV_INT}")

    math(EXPR TORCH_HIP_VERSION "(${HIP_VERSION_DEV_MAJOR} * 100) + ${HIP_VERSION_DEV_MINOR}")
    message("TORCH_HIP_VERSION: ${TORCH_HIP_VERSION}")
