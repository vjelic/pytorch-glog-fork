...
export CFLAGS="-g -fsanitize=address -shared-libasan -Wno-cast-function-type-strict -fclang-abi-compat=17"
export CXXFLAGS="-g -fsanitize=address -shared-libasan -Wno-cast-function-type-strict -fclang-abi-compat=17"
export USE_ASAN=1
export USE_CUDA=0
export USE_ROCM=1
export USE_MKLDNN=0
