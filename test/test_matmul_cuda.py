...
class TestFP8MatmulCuda(TestCase):
    ...
    def test_float8_basics(self, device) -> None:
        ...
        # these don't work on ROCm yet, only e4m3_type alone
        ...
        self._test_tautological_mm(device, e4m3_type, e4m3_type, size=32)
        self._test_tautological_mm(device, e4m3_type, e4m3_type, size=48)
