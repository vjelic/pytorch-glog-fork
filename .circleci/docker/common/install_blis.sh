...
curl -OsL --retry 3 "https://github.com/flame/blis/archive/$BLIS_VERSION.tar.gz"
...
curl -OsL --retry 3 https://github.com/flame/libflame/archive/$LIBFLAME_VERSION.tar.gz
