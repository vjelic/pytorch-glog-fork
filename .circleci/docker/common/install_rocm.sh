...
install_magma() {
    ...
    echo 'DEVCCFLAGS += --amdgpu-target=gfx900 --amdgpu-target=gfx906 --amdgpu-target=gfx908 --amdgpu-target=gfx90a --amdgpu-target=gfx1030 --amdgpu-target=gfx940 --gpu-max-threads-per-block=256' >> make.inc
